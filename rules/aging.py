import numpy as np
from config import MAX_AGE, PREDATOR_MAX_AGE, OMNI_MAX_AGE
...
def apply(state):
    ...
    return {**state, "species": species, "age": age,
            "infected": infected, "genome": genome, "gender": gender}
